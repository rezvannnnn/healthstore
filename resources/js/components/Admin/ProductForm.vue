    ...
    <div dir="rtl" class="min-h-screen bg-gray-50 px-4 py-8 text-gray-900 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-5xl">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500">اطلاعات پایه و قیمت فروش محصول</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <section class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <label class="block">
                            ...
                            <input v-model="form.slug" dir="ltr" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>

                        <label class="block">
                            <span class="text-sm font-medium">SKU</span>
                            <input v-model="form.sku" dir="ltr" class="mt-1 w-full rounded-lg border-gray-300" />
                            <span v-if="form.errors.sku" class="text-sm text-red-600">{{ form.errors.sku }}</span>
                        </label>

                        <label class="block">
                            <span class="text-sm font-medium">بارکد</span>
                            <input v-model="form.barcode" dir="ltr" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>

                        <label class="block">
                            <span class="text-sm font-medium">برند</span>
                            <select v-model="form.brand_id" class="mt-1 w-full rounded-lg border-gray-300">
                        ...
                        <label class="block">
                            ...
                            <select v-model="form.category_id" class="mt-1 w-full rounded-lg border-gray-300">
                        ...
                        <label class="block">
                            ...
                            <input v-model="form.product_type" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>

                        <label class="block">
                            <span class="text-sm font-medium">واحد</span>
                            <input v-model="form.unit" class="mt-1 w-full rounded-lg border-gray-300" placeholder="عدد، بسته، میلی‌لیتر و ..." />
                        </label>

                        <label class="block">
                            <span class="text-sm font-medium">تعداد در واحد</span>
                            <input v-model.number="form.quantity_per_unit" type="number" min="1" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>
                    </div>
                </section>
                ...
                <section class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <label class="block">
                            ...
                            <input v-model.number="form.price" type="number" min="0" step="0.01" class="mt-1 w-full rounded-lg border-gray-300" />
                        ...
                        <label class="block">
                            ...
                            <input v-model.number="form.compare_at_price" type="number" min="0" step="0.01" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>
                    </div>
                </section>
                ...
                <section class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div class="space-y-4">
                        <label class="block">
                            ...
                            <input v-model="form.short_description" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>
                        <label class="block">
                            <span class="text-sm font-medium">توضیحات کامل</span>
                            <textarea v-model="form.description" rows="6" class="mt-1 w-full rounded-lg border-gray-300" />
                        </label>
                        <div class="grid gap-4 md:grid-cols-2">
                            <label class="block">
                                <span class="text-sm font-medium">تاریخ انقضا</span>
                                <input v-model="form.expiry_date" type="date" class="mt-1 w-full rounded-lg border-gray-300" />
                            </label>
                            <label class="block">
                                <span class="text-sm font-medium">آدرس تصویر اصلی</span>
                                <input v-model="form.main_image" dir="ltr" class="mt-1 w-full rounded-lg border-gray-300" />
                            </label>
                        </div>
                    </div>
                </section>
                ...
                <div class="flex items-center justify-between">
                    <a href="/admin/products" class="rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium hover:bg-gray-100">انصراف</a>
                    <button :disabled="form.processing" type="submit" class="rounded-lg bg-gray-900 px-6 py-2.5 text-sm font-medium text-white disabled:opacity-50">
