    ...
    >
        <div class="mx-auto max-w-5xl">
            ...
            >
                ...
                >
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-7 text-dh-100">
                            سوابق خرید، وضعیت سفارش و جزئیات پرداخت را اینجا
                            ببینید.
                        </p>
                    </div>
                    <span
                        class="rounded-full bg-white/10 px-4 py-2 text-sm font-bold"
                        >{{ orders.length }} سفارش</span
                    >
                </div>
            </section>
                    ...
                    >
                        <div class="min-w-0">
                            <div class="flex flex-wrap items-center gap-2">
                                <h2 class="font-black text-dh-900">
                                    {{ order.order_number }}
                                </h2>
                                <span
                        ...
                        >
                            <div class="text-left">
                                <div class="text-lg font-black text-dh-900">
                                    {{
                                        formatAmount(
                                            order.total_amount,
                                            order.currency,
                            ...
                            <Link
                                ...
                                class="rounded-2xl bg-dh-700 px-4 py-3 text-sm font-bold text-white hover:bg-dh-800"
                            >
                                جزئیات
                            </Link>
                        </div>
            ...
            >
                ...
                <h2 class="mt-4 font-black text-dh-900">
                    هنوز سفارشی ثبت نکرده‌اید
                </h2>
                <p class="mt-2 text-sm text-dh-muted">
                    محصولات مورد نیازتان را پیدا کنید و اولین سفارش را ثبت کنید.
                </p>
                <Link
                    href="/products"
                    class="mt-5 inline-flex rounded-2xl bg-dh-700 px-5 py-3 text-sm font-bold text-white hover:bg-dh-800"
                    >مشاهده محصولات</Link
                >
            </div>
        </div>
