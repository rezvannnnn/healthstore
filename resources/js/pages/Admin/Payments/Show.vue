    ...
    >
        <div class="mx-auto max-w-4xl">
            <div class="mb-8 flex items-center justify-between gap-4">
                <div>
                    <p class="text-sm text-gray-500">HealthStore / پرداخت</p>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                >
                    ...
                    <dl class="space-y-4 text-sm">
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">مبلغ</dt>
                        ...
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">درگاه</dt>
                            <dd>{{ payment.gateway || '—' }}</dd>
                        </div>
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">Authority</dt>
                            <dd class="max-w-[65%] text-left break-all">
                                {{ payment.authority || '—' }}
                            </dd>
                        </div>
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">شماره تراکنش</dt>
                            <dd>{{ payment.transaction_id || '—' }}</dd>
                        </div>
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">شماره مرجع</dt>
                            <dd>{{ payment.reference_number || '—' }}</dd>
                        </div>
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">۴ رقم کارت</dt>
                ...
                >
                    ...
                    <dl class="space-y-4 text-sm">
                        <div class="flex justify-between gap-4">
                            <dt class="text-gray-500">شماره سفارش</dt>
                            <dd class="font-semibold">
                                {{
            ...
            >
                ...
                <pre
                    class="max-h-96 overflow-auto rounded-lg bg-gray-50 p-4 text-left text-xs whitespace-pre-wrap"
