        ...
        <div class="mx-auto max-w-7xl">
            <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">مدیریت و بررسی موجودی محصولات فروشگاه</p>
                </div>
                <Link
                    href="/admin"
            ...
            <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200">
                    ...
                    <table class="min-w-full text-right text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr v-for="product in products" :key="product.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-4">
                                    <div>{{ product.category || 'بدون دسته' }}</div>
                                    <div class="mt-1 text-xs text-gray-500">
                                ...
                                <td class="px-4 py-4">{{ product.physical_quantity }}</td>
                                <td class="px-4 py-4">{{ product.reserved_quantity }}</td>
                                <td class="px-4 py-4 font-semibold">{{ product.available_quantity }}</td>
                                <td class="px-4 py-4">
                                    <span
                ...
                <div class="flex items-center justify-between border-t px-4 py-4 text-sm text-gray-600">
