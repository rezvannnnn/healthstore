...
const nextStatusLabel = (value: string) =>
    ({
        paid: 'تأیید پرداخت',
            ...
            >
                    ...
                    <table class="min-w-full text-right text-sm">
                        <thead class="border-b text-dh-muted">
                            <tr>
                                ...
                                <th class="px-2 py-3">قیمت واحد</th>
                                <th class="px-2 py-3">جمع</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y">
                            <tr v-for="item in order.items" :key="item.id">
                                ...
                                <td class="px-2 py-3 font-medium">
                                    {{
                                        formatAmount(Number(item.total_amount))
                                    }}
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="mt-5 border-t pt-4 text-sm">
                    <div class="flex justify-between">
                        ...
                        ><span>{{ formatAmount(Number(order.subtotal)) }}</span>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <span>تخفیف</span
                        ><span>{{
                            formatAmount(Number(order.discount_amount))
                        }}</span>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <span>ارسال</span
                        ><span>{{
                            formatAmount(Number(order.shipping_amount))
                        }}</span>
                    </div>
                    <div class="mt-3 flex justify-between text-base font-bold">
