        ...
        <main class="mx-auto max-w-7xl space-y-8 px-4 py-6 md:px-6 md:py-10">
                ...
                <div class="relative">
                    ...
                    >
                        <div class="max-w-2xl">
                            <Link
                                href="/blog"
                                class="inline-flex rounded-full bg-white/10 px-3 py-1.5 text-xs font-bold text-dh-50 ring-1 ring-white/15"
                                >مجله سلامت</Link
                            >
                            <h1
                            ...
                            <p
                                class="mt-4 max-w-xl text-sm leading-7 text-dh-50/85 md:text-base"
                            >
                                راهنماها و مطالب آموزشی برای انتخاب بهتر
                                محصولات، مراقبت روزانه و سبک زندگی سالم.
                            </p>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div class="mt-1 text-sm text-dh-50/75">
                                مطلب منتشرشده
                            </div>
                        </div>
                    </div>
            ...
            <section class="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
                <form
                    method="get"
                    action="/blog"
                    class="flex gap-2 rounded-2xl border border-dh-100 bg-white p-2 shadow-sm"
                >
                    <label for="blog-search" class="sr-only"
                        >جستجو در مقالات</label
                    >
                    <div class="flex min-w-0 flex-1 items-center gap-2 px-3">
                        <svg
                            viewBox="0 0 24 24"
                            class="size-5 shrink-0 text-dh-muted"
                            fill="none"
                            stroke="currentColor"
                            stroke-width="2"
                        >
                        ...
                        <input
                            ...
                            class="w-full border-0 bg-transparent py-2.5 text-sm outline-none placeholder:text-dh-muted focus:ring-0"
                            placeholder="مثلاً: ویتامین D، مراقبت پوست..."
                        />
                    </div>
                    <button
                        class="rounded-xl bg-dh-700 px-5 py-2.5 text-sm font-bold text-white hover:bg-dh-800"
                    >
                        جستجو
                    </button>
                </form>
                <Link
                    ...
                    class="rounded-2xl border border-dh-100 bg-white px-5 py-3 text-center text-sm font-bold text-dh-700 shadow-sm hover:bg-dh-50"
                    >مشاهده همه دسته‌ها</Link
                >
            </section>
            ...
            <section v-if="categories.length" class="space-y-3">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <Link
                        href="/blog/categories"
                        class="text-xs font-bold text-dh-700"
                        >همه دسته‌ها</Link
                    >
                </div>
                <div class="flex gap-2 overflow-x-auto pb-1">
                    <Link
                        ...
                        class="shrink-0 rounded-full border border-dh-100 bg-white px-4 py-2 text-sm font-semibold text-dh-muted shadow-sm hover:border-dh-200 hover:text-dh-800"
                        >{{ category.name }}</Link
                    >
                </div>
            </section>
            ...
            <section class="space-y-4">
                    ...
                    >
                        <Link :href="`/blog/${article.slug}`" class="block">
                            <div class="relative overflow-hidden bg-dh-50">
                                ...
                                <div
                                    v-else
                                    class="flex h-52 items-center justify-center bg-dh-50 text-dh-300"
                                >
                                    <svg
                                        viewBox="0 0 48 48"
                                        class="size-14"
                                ...
                                <span
                                    class="absolute top-4 right-4 rounded-full bg-white/95 px-3 py-1 text-[11px] font-bold text-dh-700 shadow-sm"
                                    >{{
                            ...
                            <div class="space-y-3 p-5">
                                ...
                                <span
                                    class="inline-flex items-center gap-2 pt-1 text-sm font-black text-dh-700"
                                    >ادامه مطلب
                ...
                >
                    ...
                    <p class="mt-2 text-sm text-dh-muted">
                        عبارت جستجو را تغییر دهید یا همه مطالب را ببینید.
                    </p>
                    <Link
                        href="/blog"
                        class="mt-5 inline-flex rounded-xl bg-dh-700 px-5 py-2.5 text-sm font-bold text-white"
                        >نمایش همه مطالب</Link
                    >
                </div>
            </section>
                ...
                <Link
                    ...
                    :class="
                        page === pagination.current_page
                            ? 'bg-dh-700 text-white shadow-sm'
