        ...
        <main class="mx-auto max-w-6xl space-y-6 px-4 py-6 md:px-6 md:py-10">
            <header>
                ...
                <p class="mt-2 text-sm leading-7 text-dh-muted">
                    آدرس، اقلام و مبلغ نهایی را بررسی کنید؛ سپس برای پرداخت
                    ادامه دهید.
                </p>
            </header>
            ...
            <section class="grid gap-6 lg:grid-cols-[1fr_350px]">
                <div class="space-y-5">
                    ...
                    >
                        ...
                        >
                            <div>
                                <span
                                    class="flex size-9 items-center justify-center rounded-xl bg-dh-50 text-sm font-black text-dh-700"
                                    >۱</span
                                >
                                <h2 class="mt-3 text-xl font-black text-dh-800">
                                    آدرس تحویل
                                </h2>
                                <p class="mt-1 text-sm leading-6 text-dh-muted">
                                    آدرسی را که می‌خواهید سفارش به آن ارسال شود
                                    انتخاب کنید.
                                </p>
                            </div>
                            <Link
                                href="/account/addresses"
                                class="shrink-0 text-xs font-bold text-dh-700"
                                >مدیریت آدرس‌ها</Link
                            >
                        </div>
                        <div
                            v-if="addresses.length === 0"
                            class="rounded-2xl border border-dashed border-dh-200 bg-dh-surface p-6"
                        >
                            <strong class="text-dh-800"
                                >هنوز آدرسی ثبت نکرده‌اید.</strong
                            >
                            <p class="mt-2 text-sm text-dh-muted">
                                برای ادامه سفارش، ابتدا یک آدرس ثبت کنید.
                            </p>
                            <Link
                                class="mt-4 inline-flex rounded-xl bg-dh-700 px-4 py-2.5 text-sm font-bold text-white"
                                href="/account/addresses"
                                >ثبت آدرس جدید</Link
                            >
                        </div>
                            ...
                            <label
                                ...
                                :class="
                                    selectedAddressId === address.id
                                        ? 'border-dh-600 bg-dh-50/50 ring-2 ring-dh-100'
                                        : 'border-dh-100 bg-white hover:border-dh-200'
                                "
                            >
                                <input
                                    ...
                                    :value="address.id"
                                    class="mt-1 accent-dh-700"
                                />
                                <span class="min-w-0 flex-1">
                                    <span
                                        class="flex flex-wrap items-center gap-2"
                                        ><strong class="text-sm text-dh-800">{{
                                            address.title || 'آدرس'
                                        }}</strong
                                        ><span
                                            v-if="address.is_default"
                                            class="rounded-full bg-dh-green-50 px-2 py-0.5 text-[10px] font-bold text-dh-green-700"
                                            >پیش‌فرض</span
                                        ></span
                                    >
                                    <span class="mt-2 block text-sm text-dh-800"
                                        >{{ address.recipient_name }} ·
                                        {{ address.phone }}</span
                                    >
                                    <span
                                        class="mt-1 block text-sm leading-7 text-dh-muted"
                                        >{{ address.province
                                        }}{{
                                    ...
                                    <span
                                        ...
                                        class="mt-1 block text-xs text-dh-muted"
                                        >کد پستی:
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            >
                            <div>
                                <h2 class="text-xl font-black text-dh-800">
                                    کد تخفیف
                                </h2>
                                <p class="mt-1 text-sm leading-6 text-dh-muted">
                                    در صورت داشتن کد، آن را وارد کنید.
                                </p>
                            </div>
                        </div>
                        ...
                        <p class="mt-3 text-xs leading-6 text-dh-muted">
                            اعتبار و میزان تخفیف هنگام ثبت سفارش در سمت سرور
                            بررسی می‌شود.
                        </p>
                    </section>
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm leading-7 text-amber-800">
                            از آخرین مراجعه شما، وضعیت یکی یا چند محصول تغییر
                            کرده است. موارد زیر را بررسی کنید.
                        </p>
                        <div v-if="hasPriceChanges" class="mt-5 space-y-2">
                            ...
                            <div
                                ...
                                class="flex flex-wrap items-center justify-between gap-3 rounded-2xl bg-white/70 p-3 text-sm"
                            >
                                <strong>{{ change.product_name }}</strong
                                ><span
                                    ><span class="text-dh-muted line-through">{{
                        ...
                        <div v-if="hasOutOfStockItems" class="mt-5 space-y-2">
                            <h3 class="text-sm font-black text-amber-900">
                                محصولات ناموجود
                            </h3>
                            <div
                            ...
                            >
                                ...
                                ><span class="font-bold text-red-600"
                                    >ناموجود ·
                                    <span
                                        class="font-normal text-dh-muted line-through"
                                        >{{
                                            formatPrice(change.old_price)
                                        }}</span
                                    ></span
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-dh-muted">
                                    {{
                                        cart.items.length.toLocaleString(
                                            'fa-IR',
                                        )
                                    }}
                                    قلم در سفارش
                        ...
                        <div
                            ...
                            class="mt-5 rounded-2xl bg-dh-surface p-5 text-center text-sm text-dh-muted"
                        >
                        ...
                        <div
                            ...
                            :key="item.id"
                            class="flex items-center justify-between gap-4 border-b border-dh-100 py-4 last:border-0 last:pb-0"
                        >
                            <div class="min-w-0">
                                <h3
                                    class="line-clamp-2 text-sm leading-6 font-black text-dh-800"
                                >
                                    {{ item.product.name }}
                                </h3>
                                <div
                                    class="mt-1 flex flex-wrap gap-3 text-xs text-dh-muted"
                                >
                            ...
                            <div
                                class="shrink-0 text-left text-sm font-black text-dh-800"
                            >
                ...
                >
                    ...
                    <div
                        class="mt-5 flex items-center justify-between text-sm text-dh-muted"
                    >
                    ...
                    <div
                        ...
                        class="mt-3 flex items-center justify-between text-sm text-dh-green-700"
                    >
                        <span>تخفیف</span
                        ><strong
                    ...
                    <div class="flex items-end justify-between gap-3">
                        ...
                        ><strong class="text-xl font-black text-dh-700">{{
                    ...
                    <section
                        v-if="!hasPayableItems"
                        class="mt-6 rounded-2xl bg-amber-50 p-4"
                    >
                        <div class="font-black text-amber-900">
                            کالای قابل خریدی باقی نمانده است.
                        </div>
                        ...
                        <button
                            type="button"
                            class="mt-4 w-full rounded-xl bg-white px-4 py-3 text-sm font-bold text-dh-700 ring-1 ring-dh-100"
                            @click="goBackToCart"
                        >
                            بازگشت به سبد خرید
                        </button>
                    ...
                    <section
                        ...
                        class="mt-6 rounded-2xl bg-dh-surface p-4"
                    >
                        <div class="font-black text-dh-800">
                            آدرس تحویل لازم است
                        </div>
                        <p class="mt-1 text-xs leading-6 text-dh-muted">
                            برای ثبت سفارش، ابتدا یک آدرس ثبت کنید.
                        </p>
                    </section>

                    <section v-else-if="requiresPriceConfirmation" class="mt-6">
                        <div class="rounded-2xl bg-dh-50 p-4">
                            <div class="font-black text-dh-800">
                                تأیید تغییرات
                            </div>
                            <p class="mt-1 text-xs leading-6 text-dh-muted">
                                برای ادامه، تغییرات سبد و آدرس تحویل را تأیید
                                کنید.
                            </p>
                        </div>
                        <button
                            type="button"
                            class="mt-3 w-full rounded-2xl bg-dh-700 px-5 py-3.5 text-sm font-black text-white shadow-sm hover:bg-dh-800 disabled:cursor-not-allowed disabled:opacity-50"
                            :disabled="
                                submitting ||
                                !canProceedToPayment ||
                                !hasAddress
                        ...
                        <button
                            type="button"
                            class="mt-2 w-full rounded-2xl border border-dh-100 bg-white px-5 py-3 text-sm font-bold text-dh-700 hover:bg-dh-50"
                            :disabled="submitting"
                            @click="rejectChanges"
                        >
                            {{
                    ...
                    <section v-else class="mt-6">
                        <div class="rounded-2xl bg-dh-green-50 p-4">
                            <div class="font-black text-dh-green-700">
                                سفارش آماده است
                            </div>
                            <p
                                class="mt-1 text-xs leading-6 text-dh-green-700/80"
                            >
                                آدرس و قیمت سفارش را بررسی کرده‌اید.
                            </p>
                        </div>
                        <button
                            type="button"
