...
class ExampleTest extends TestCase
{
    ...
    public function test_product_can_be_added_to_cart_with_current_price(): void
    {
        ...
        $this->assertEquals(
            300000,
            $service->calculateSubtotal($cart)
        );
    }
    ...
    public function test_checkout_detects_price_change_and_updates_cart(): void
    {
        ...
        $this->assertTrue(
            $result['requires_price_confirmation']
        );
        ...
        $this->assertEquals(
            150000,
            $result['changes'][0]['old_price']
        );

        $this->assertEquals(
            180000,
            $result['changes'][0]['new_price']
        );
    ...
    public function test_checkout_does_not_require_confirmation_when_price_is_unchanged(): void
    {
        ...
        $product = Product::create([
            'name' => 'Checkout Stable Product',
            'slug' => 'checkout-stable-product',
            'sku' => 'CHECKOUT-002',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
    ...
    public function test_customer_can_confirm_changed_price_and_continue(): void
    {
        ...
        $product = Product::create([
            'name' => 'Confirm Price Product',
            'slug' => 'confirm-price-product',
            'sku' => 'CONFIRM-001',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
        ...
        $this->assertTrue(
            $checkout['requires_price_confirmation']
        );

        $this->assertEquals(
            180000,
            (float) $checkout['cart']->items->first()->unit_price
        );
    ...
    public function test_customer_can_reject_changed_price_and_keep_updated_cart(): void
    {
        ...
        $product = Product::create([
            'name' => 'Reject Price Product',
            'slug' => 'reject-price-product',
            'sku' => 'REJECT-001',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
    ...
    {
        $product = Product::create([
            'name' => 'Inactive Inventory Product',
            'slug' => 'inactive-inventory-product',
            'sku' => 'INV-003',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
    ...
    public function test_checkout_marks_out_of_stock_product_and_sets_price_to_zero(): void
    {
        ...
        $product = Product::create([
            'name' => 'Out Of Stock Checkout Product',
            'slug' => 'out-of-stock-checkout-product',
            'sku' => 'OOS-CHECKOUT-001',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
            'is_featured' => false,
    ...
    public function test_customer_confirmation_removes_out_of_stock_product_from_cart(): void
    {
        ...
        $product = Product::create([
            'name' => 'Remove Out Of Stock Product',
            'slug' => 'remove-out-of-stock-product',
            'sku' => 'OOS-CONFIRM-001',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
        ...
        // No payable items remain after the unavailable item is removed.
        $this->assertFalse(
            $result['payment_allowed']
        );
    ...
    public function test_customer_rejection_keeps_out_of_stock_product_in_cart(): void
    {
        ...
        $product = Product::create([
            'name' => 'Reject Out Of Stock Product',
            'slug' => 'reject-out-of-stock-product',
            'sku' => 'OOS-REJECT-001',
            'product_type' => 'physical',
            'unit' => 'piece',
            'is_active' => true,
